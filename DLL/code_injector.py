...
sc = sc.replace(replace_string, replace_value)
code_size = len(sc)
...
arg_address = kernel32.VirtualAllocEx( h_process, 0, code_size, VIRTUAL_MEM, PAGE_READWRITE )
...
print "[*] Remote thread created with a thread ID 0x%08x." % thread_id.value 
